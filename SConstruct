...
for a in range(1,41):
    env = env0
    SConscript('lib'+str(a)+'/SConscript', variant_dir = 'bin0/lib'+str(a), exports=['env'])
    env = env1
    SConscript('lib'+str(a)+'/SConscript', variant_dir = 'bin1/lib'+str(a), exports=['env'])
    env = env2
    SConscript('lib'+str(a)+'/SConscript', variant_dir = 'bin2/lib'+str(a), exports=['env'])
